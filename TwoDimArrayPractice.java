...
public class TwoDimArrayPractice extends JFrame
{
   ...
   */
   ...
   public void printArray( )
   {
    ...
    // Write your code here:
	   System.out.print("_________PrintArray_______\n");
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    //  and column is the index of the array's current column
    // Write your code here:
	   System.out.println("________Setting the Value______ for row #"+row+ " with value " +value);
	   for (int x = 0; x < intArray.length; x++) 
	   {
	   if (x == row) 
	   {
	   for (int count = 0; count < intArray[count].length; count++) 
	   {
	   intArray[x][count] = value;

	   }

	}
}
	   System.out.println("_____Done.");
   }
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   System.out.println("____Minimum from column #" +column);
	   int min = Integer.MAX_VALUE;
	   for (int count = 0; count < intArray.length; count++) {
	   if (min > intArray[count][column]) {
	   min = intArray[count][column];
	   }
	   animate(count, column, min); 
	   }
	   System.out.println("Minimum in column #" + column + " is equal to " + min);
	   return min;
   }
   ...
   */
   public int countFound( int value )
   {
    ...
    // Write your code here:
	   System.out.println("_____Frequency of "+value+" in the matrix.");
	   int count = 0; 
	   for (int x = 0; x<intArray.length;x++) {
	   for (int y = 0; y<intArray[x].length; y++) {

	   if (intArray[x][y] == value) {
	   ...
	   System.out.println(value +" occurs about "+count+" times.");
	   return count;
   }
